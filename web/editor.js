...
E.facebookShare=function() {
  window.open("https://www.facebook.com/sharer/sharer.php?u="+escape(httpRef())+'&t='+document.title, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600')
}
